...
if page == pages[2] : 
  ...
  if  (visu == "Nombre d'accidents par heure"):
  ...
  if  (visu == "Nombre d'accidents par jour de la semaine"):
  ...
  if  (visu == "Nombre d'accidents par mois"):
  ...
  if  (visu == "gravité de l'accident en fonction du genre"):
  ...
  if  (visu == "correlation des données caracteristiques"):
  ...
  if  (visu == "correlation des données usagers"):
